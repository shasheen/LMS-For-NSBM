  ...
  <div id="mainbody">
    ...
    <br>
     <div name="comcert" class="modules" >
       <ul>
                   <li><a href="FileViewLec.php?modulename=MA">MA001.2 - Fundamentals of Mathematics (MA)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=IS">MA002.2 - Introduction to Statistics (IS)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=AW">CS001.2 - Academic Writing (AW)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=ICA">CS002.2 - Introduction to Computer Applications (ICA)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=CBS">CS003.2 - Communication and Business Skills (CBS)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=ADC">CS004.10 - Application Development with C Language (ADC)
                   </a></li><br>
                   <li><a href="FileViewLec.php?modulename=CSP">CS107.3 Programming with C# -Plymouth Group A(CSP)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=INTRO">CS101.3 Introduction to Computer Science(INTRO)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=CA">CS104.3 Computer Architecture(CA)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=WEB">SE102.3 Web Based Application Development(WEB)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=ALGO">CS106.3 Algorithms and Data structures - DM(ALGO)</a></li><br>
                   <li><a href="FileViewLec.php?modulename=SAD">SE103.3 System Analysis and Design(SAD)
                   </a></li><br>              
                   </ul>
     </div>
