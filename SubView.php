...
<table style= "margin-left: 35%" border="1">
					...
					$mymodulename=$_GET['modulename'];
						...
						$sql = "SELECT Date,Location FROM submition where ModuleName='$mymodulename'";
					...
					while($row=$result->fetch_assoc()){ 
						$location=$row['Location'];							
							...
							echo "<tr><td>{$row['Date']}</td><td><a href='$location'><img style='width:50px;height:50px;' src='css/images/doc1.png'></a></td></tr>";
							}
